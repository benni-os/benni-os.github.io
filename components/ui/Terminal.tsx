...
const TERM_LINES: TermLine[] = [
  { cls: 'text-txt3', t: '// JARVAS-2 control-plane -- boot sequence' },
  { cls: 'text-c3 font-semibold', t: '[OK] benni-control-plane     :3000  LIVE' },
  { cls: 'text-c3 font-semibold', t: '[OK] benni-memory-mcp        :3001  LIVE' },
  { cls: 'text-c3 font-semibold', t: '[OK] benni-ops-gateway       :3002  LIVE' },
  { cls: 'text-c3 font-semibold', t: '[OK] benni-research-fusion   :3003  LIVE' },
  ...
  { cls: 'text-txt', t: '  Formation: BRAVO -- Build & Ship' },
  { cls: 'text-txt', t: '  Agents:    4 active  /  2 queued' },
  { cls: 'text-txt', t: '  Memory:    12,847 vectors indexed' },
  { cls: 'text-txt3', t: '' },
  { cls: 'text-c2 font-bold', t: '> dispatch_swarm({ target: "tier-1" })' },
  { cls: 'text-gold font-semibold', t: '  [!] ALPHA formation deployed' },
  { cls: 'text-gold font-semibold', t: '  [!] Revenue loop: FOXTROT active' },
  { cls: 'text-txt3', t: '' },
  { cls: 'text-c1 font-bold', t: '> status' },
  { cls: 'text-c3 font-bold', t: '  ALL SYSTEMS OPERATIONAL' }
];

const TELEMETRY_POOL = [
  { cls: 'text-txt3', t: '[TICK] memory:gc  freed 847 vectors  +14ms' },
  { cls: 'text-c1',  t: '[TICK] swarm:ALPHA  task_complete  rev+$0.12' },
  { cls: 'text-c3',  t: '[TICK] jarvas:heartbeat  latency:1.8ms  OK' },
  ...
  useEffect(() => {
    ...
    function typeLine() {
      if (lineIdx >= TERM_LINES.length) {
        // Start live telemetry stream loop
